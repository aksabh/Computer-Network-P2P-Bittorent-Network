...
public class Client2Handler implements Runnable{
	...
	public Client2Handler(Socket connection, int no, int clientnum, int arr[]) 
	{
	...
	public void sendFile(String fileName2, int x) {
        try {
          // String fileName2="/Users/akshatsharma/Documents/workspace/Networks/src/client1/RecievedFiles/"+fileName;
        	fileName2="src/client2/"+fileName2;
        	System.out.println("File I am sending:"+fileName2);
